            ...
            try {
                for (int i = 0; i < 5; i++) {
                    ...
                    if(Thread.currentThread().isAlive() && !Thread.currentThread().isInterrupted()) {
                        ...
                        NotificationCompat.Builder builder = new NotificationCompat.Builder(self, CHANNEL_ID)
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                            ...
                            NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Notif", importance);
                            channel.setDescription("A notification channel");
                        ...
                        Intent resultIntent = new Intent(self, HelloThereService.class);
                        TaskStackBuilder stackBuilder = TaskStackBuilder.create(self);
